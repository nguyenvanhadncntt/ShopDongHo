<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="ThongKeHangCon.aspx.cs" Inherits="ShopDongHo.ThongKeHangCon" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
       ...
       <table style="width: 100%; background-color: #93dafd;">
        ...
        <tr>
            <td style="text-align: center; color: #0000FF; background-color: #FFFFFF;" colspan="15">
                &nbsp;</td>
        </tr>
        <tr>
