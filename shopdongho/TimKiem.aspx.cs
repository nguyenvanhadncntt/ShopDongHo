...
namespace ShopDongHo
{
    public partial class TimKiem : System.Web.UI.Page
    {
        ...
        Double Tongtien()
        {
            ...
            Session["sl"] = objDT.Rows.Count.ToString();
            return s;
        }
        ...
        {
            KetNoi kn = new KetNoi();
            String tensp = (String)Request.QueryString["tensp"];
            DataTable dt= kn.loadDT("select * from SANPHAM s join NHOMHANG n on s.MaNH=n.MANH where TenSP like '%" + tensp + "%'");
